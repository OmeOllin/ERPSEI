...
function operateFormatter(value, row, index) {
    return [
        '<a class="see" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#dlgOficina" title="' + btnVerTitle + '">',
            '<i class="bi bi-search"></i>',
        '</a>  ',
        '<a class="edit" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#dlgOficina" title="' + btnEditarTitle + '">',
