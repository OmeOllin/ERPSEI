...
function operateFormatter(value, row, index) {
    return [
        '<a class="see btn" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#dlgOficina" title="' + btnVerTitle + '">',
            '<i class="bi bi-search"></i>',
        '</a>  ',
        '<a class="edit btn" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#dlgOficina" title="' + btnEditarTitle + '">',
...
window.operateEvents = {
    'click .see': function (e, value, row, index) {
        initOficinaDialog(VER, row);
    },
    'click .edit': function (e, value, row, index) {
        initOficinaDialog(EDITAR, row);
...
function onAgregarClick() {
    initOficinaDialog(NUEVO, { id: "Nuevo", nombre: "" });
}
function initTable() {
...
function initOficinaDialog(action, row) {
    let idField = document.getElementById("inpOficinaId");
    let nombreField = document.getElementById("inpOficinaNombre");
    let btnGuardar = document.getElementById("dlgOficinaBtnGuardar");
...
function onGuardarClick() {
    ...
    let btnClose = document.getElementById("dlgOficinaBtnCancelar");
    let idField = document.getElementById("inpOficinaId");
    let nombreField = document.getElementById("inpOficinaNombre");
    let dlgTitle = document.getElementById("dlgOficinaTitle");
    let summaryContainer = document.getElementById("saveValidationSummary");
    ...
    doAjax(
        "/Catalogos/Oficinas/SaveOficina",
        oParams,
        function (resp) {
            if (resp.tieneError) {
